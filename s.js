...
const questions = [
  ...
  { text: 'Copy this design: Draw a four-sided figure between two five-sided figures.', image: "paper_fold.png", points: 1, time: 60 },
...
function loadQuestion(index) {
  ...
  if (question.time) startTimer(question.time);
